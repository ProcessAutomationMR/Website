...
export function SarlatPage() {
  useEffect(() => {
    analyticsService.logNavigation('Menuisier Sarlat-la-Canéda', 'SEO Page');
  }, []);
  ...
  const nearbyLocations = [
    ...
    { name: 'Bordeaux', distance: '120 km' },
    { name: 'Bergerac', distance: '25 km' },
    { name: 'Arcachon', distance: '150 km' },
    { name: 'Cap Ferret', distance: '165 km' },
  ];
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-neutral-400 text-lg">Sarlat-la-Canéda et environs</span>
            </div>
            <h1 className="text-5xl font-light mb-6 tracking-wide">
              Menuisier à Sarlat-la-Canéda
            </h1>
            <p className="text-xl text-neutral-300 font-light leading-relaxed">
              Artisan menuisier expert en menuiserie traditionnelle et contemporaine, GBM MENUISERIE intervient à Sarlat-la-Canéda et dans toute la Dordogne pour vos projets de menuiserie sur mesure, agencement et laquage.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          <section>
            <h2 className="text-3xl font-light text-white mb-6">
              Votre menuisier expert à Sarlat-la-Canéda
            </h2>
            <div className="space-y-4 text-neutral-300 leading-relaxed">
              <p>
                Vous recherchez un <strong>menuisier professionnel à Sarlat-la-Canéda</strong> pour vos travaux de menuiserie traditionnelle ou contemporaine ? GBM MENUISERIE, artisan menuisier établi à Sigoulès près de Bergerac, intervient dans toute la région de Sarlat-la-Canéda pour réaliser vos projets sur mesure.
              </p>
              <p>
          ...
          <section>
            <h2 className="text-3xl font-light text-white mb-6">
              Nos prestations de menuiserie à Sarlat-la-Canéda
            </h2>
            ...
            <p className="text-neutral-300 leading-relaxed">
              Notre entreprise de menuiserie intervient pour les particuliers et professionnels à Sarlat-la-Canéda et dans toute la Dordogne. Nous nous adaptons à vos contraintes et à vos envies pour créer des <strong>menuiseries esthétiques et fonctionnelles</strong> qui valorisent vos espaces.
            </p>
          </section>

          <section>
            <h2 className="text-3xl font-light text-white mb-6">
              Menuiserie d'agencement pour professionnels
            </h2>
            <div className="space-y-4 text-neutral-300 leading-relaxed">
              <p>
                Propriétaires de commerces ou de restaurants à Sarlat-la-Canéda ? Nous réalisons votre <strong>agencement commercial sur mesure</strong> pour dynamiser et valoriser vos espaces de vente. De la conception à la pose, nous créons des aménagements professionnels en panneaux mélaminé ou MDF, adaptés aux exigences du commerce.
              </p>
              <p>
                Notre expertise en <strong>menuiserie d'agencement</strong> nous permet de concevoir des mobiliers professionnels robustes, esthétiques et parfaitement intégrés à votre activité.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-3xl font-light text-white mb-6">
              Zone d'intervention autour de Sarlat-la-Canéda
            </h2>
            <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-8">
              ...
              <p className="text-neutral-400 text-sm mt-6 leading-relaxed">
                Basés à Sigoulès, nous intervenons dans toute la région de Sarlat-la-Canéda, incluant le Périgord Noir, la vallée de la Dordogne, et les communes environnantes.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-neutral-900 to-neutral-800 border border-neutral-800 rounded-lg p-10">
            ...
            <p className="text-neutral-300 leading-relaxed mb-8">
              Pour tout projet de <strong>menuiserie à Sarlat-la-Canéda</strong>, contactez GBM MENUISERIE. Nous étudions votre demande et vous proposons un devis personnalisé adapté à vos besoins et à votre budget.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/contact"
                onClick={() => analyticsService.logNavigation('Sarlat Page: Contact CTA', 'SEO Page')}
              ...
              <a
                href="tel:0631050485"
                onClick={() => analyticsService.logNavigation('Sarlat Page: Phone CTA', 'SEO Page')}
          ...
          <section>
            ...
            <p className="text-neutral-400 text-sm">
              Entreprise certifiée, garantie décennale • RGE • Artisan qualifié
            </p>
          </section>
        </div>
      </div>
