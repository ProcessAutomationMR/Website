...
export function BordeauxPage() {
  useEffect(() => {
    analyticsService.logNavigation('Menuisier Bordeaux', 'SEO Page');
  }, []);
  ...
  const nearbyLocations = [
    ...
    { name: 'Bordeaux Centre', distance: '120 km' },
    { name: 'Bordeaux Métropole', distance: '110-130 km' },
    { name: 'Mérignac', distance: '115 km' },
    { name: 'Pessac', distance: '118 km' },
  ];
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-neutral-400 text-lg">Bordeaux et agglomération</span>
            </div>
            ...
            <p className="text-xl text-neutral-300 font-light leading-relaxed">
              Artisan menuisier expert en menuiserie traditionnelle et contemporaine, GBM MENUISERIE intervient à Bordeaux et dans toute la métropole bordelaise pour vos projets de menuiserie sur mesure, agencement et laquage.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          <section>
            <h2 className="text-3xl font-light text-white mb-6">
              Votre menuisier expert à Bordeaux
            </h2>
            <div className="space-y-4 text-neutral-300 leading-relaxed">
              <p>
                Vous recherchez un <strong>menuisier professionnel à Bordeaux</strong> pour vos travaux de menuiserie traditionnelle ou contemporaine ? GBM MENUISERIE, artisan menuisier établi à Sigoulès près de Bergerac, intervient dans toute la région bordelaise pour réaliser vos projets sur mesure.
              </p>
              <p>
          ...
          <section>
            <h2 className="text-3xl font-light text-white mb-6">
              Nos prestations de menuiserie à Bordeaux
            </h2>
            ...
            <p className="text-neutral-300 leading-relaxed">
              Notre entreprise de menuiserie intervient pour les particuliers et professionnels à Bordeaux et dans toute la métropole. Nous nous adaptons à vos contraintes et à vos envies pour créer des <strong>menuiseries esthétiques et fonctionnelles</strong> qui valorisent vos espaces.
            </p>
          </section>

          <section>
            <h2 className="text-3xl font-light text-white mb-6">
              Menuiserie d'agencement pour professionnels à Bordeaux
            </h2>
            <div className="space-y-4 text-neutral-300 leading-relaxed">
              <p>
                Propriétaires de commerces ou de restaurants à Bordeaux ? Nous réalisons votre <strong>agencement commercial sur mesure</strong> pour dynamiser et valoriser vos espaces de vente. De la conception à la pose, nous créons des aménagements professionnels adaptés aux exigences du commerce bordelais.
              </p>
              <p>
                Notre expertise en <strong>menuiserie d'agencement</strong> nous permet de concevoir des mobiliers professionnels robustes, esthétiques et parfaitement intégrés à votre activité, que ce soit dans le centre-ville de Bordeaux ou dans la métropole.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-3xl font-light text-white mb-6">
              Zone d'intervention à Bordeaux et alentours
            </h2>
            <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-8">
              ...
              <p className="text-neutral-400 text-sm mt-6 leading-relaxed">
                Basés à Sigoulès, nous intervenons dans toute la région bordelaise, incluant Bordeaux centre, la métropole, et les communes de la rive droite et rive gauche.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-neutral-900 to-neutral-800 border border-neutral-800 rounded-lg p-10">
            ...
            <p className="text-neutral-300 leading-relaxed mb-8">
              Pour tout projet de <strong>menuiserie à Bordeaux</strong>, contactez GBM MENUISERIE. Nous étudions votre demande et vous proposons un devis personnalisé adapté à vos besoins et à votre budget.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/contact"
                onClick={() => analyticsService.logNavigation('Bordeaux Page: Contact CTA', 'SEO Page')}
              ...
              <a
                href="tel:0631050485"
                onClick={() => analyticsService.logNavigation('Bordeaux Page: Phone CTA', 'SEO Page')}
