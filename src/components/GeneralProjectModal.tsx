...
export function GeneralProjectModal({ onClose }: GeneralProjectModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    analyticsService.logButtonClick('Submit general project inquiry');
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-neutral-900 border border-neutral-700 rounded-lg max-w-2xl w-full my-8">
        <div className="flex items-center justify-between p-6 border-b border-neutral-800">
          <h2 className="text-2xl font-light text-white">Parlez-nous de votre projet</h2>
          <button
            onClick={() => {
              analyticsService.logButtonClick('Close general project modal');
              onClose();
            }}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <p className="text-neutral-300 font-light">
            Décrivez-nous votre projet en détail et nous vous contacterons rapidement pour en discuter.
          </p>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Décrivez votre projet en détail : type de menuiserie ou agencement souhaité, dimensions, matériaux, style, délais, etc."
              required
            />
          </div>
          ...
          <div className="flex gap-4 pt-4">
            <button
              type="button"
              onClick={() => {
                analyticsService.logButtonClick('Cancel general project inquiry');
                onClose();
              }}
